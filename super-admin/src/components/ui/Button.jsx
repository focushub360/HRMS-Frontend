...
const Button = ({ 
  ...
  const variants = {
    ...
    outline: 'border border-primary-600 text-primary-600 hover:bg-primary-50 focus:ring-primary-500 disabled:border-primary-300 disabled:text-primary-300 dark:border-primary-500 dark:text-primary-300 dark:hover:bg-gray-800'
  };
