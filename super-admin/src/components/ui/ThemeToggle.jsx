...
const ThemeToggle = () => {
  ...
  const handleToggle = () => {
    // Prefer provider's toggle if available
    if (typeof toggleTheme === 'function') {
      toggleTheme();
      if (typeof import.meta !== 'undefined' && import.meta.env && import.meta.env.DEV) {
        console.debug('[ThemeToggle] toggleTheme ->', { theme, resolvedTheme });
      }
      return;
    }

    // Fallback: cycle manually
  ...
  return (
    <div className="flex items-center space-x-3">
      ...
      >
        ...
        >
          <span className="pointer-events-none text-gray-700 dark:text-gray-100">
