        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-wrap border-b border-gray-200 dark:border-gray-700">
                <button
                    ...
                    className={`px-4 py-2 text-sm font-medium transition-colors ${activeTab === 'shifts'
                ...
                <button
                    ...
                    className={`px-4 py-2 text-sm font-medium transition-colors ${activeTab === 'departments'
                            ? 'text-primary-600 border-b-2 border-primary-600'
                            : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                        }`}
                >
                        ...
                        <Card key={shift._id} className="hover:shadow-lg transition-shadow">
                            <Card.Content className="p-5">
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <span className={`px-2 py-1 text-xs rounded-full ${shift.isActive
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            >
                                ...
                                <option value="evening">Afternoon Shift</option>
                ...
                <div className="space-y-4">
                    <div className="flex border-b border-gray-200 dark:border-gray-700">
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-medium transition-colors ${assignmentModal.tab === 'departments'
                                    ? 'text-primary-600 border-b-2 border-primary-600'
                        ...
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-medium transition-colors ${assignmentModal.tab === 'roles'
                                    ? 'text-primary-600 border-b-2 border-primary-600'
                                    : 'text-gray-500 hover:text-gray-700'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-medium transition-colors ${assignmentModal.tab === 'employees'
                                    ? 'text-primary-600 border-b-2 border-primary-600'
                                    : 'text-gray-500 hover:text-gray-700'
                                }`}
                        >
